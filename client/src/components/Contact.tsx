...
const Contact = () => {
	...
	return (
		<section className="py-10 flex flex-col items-center px-3 bg-[#f5f9f5] md:pt-32 dark:bg-[#f3f9f507]" id="contact">
			<Reveal>
			...
			<div className="mt-5 w-full md:mt-10">
				<div className="py-10 max-w-[1200px] mx-auto flex flex-col gap-y-7 gap-x-7 md:flex-row">
